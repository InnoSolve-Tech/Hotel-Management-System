...
((e = function () {
    ...
    var y =
        ((function (e) {
            ...
            function o(e) {
                for (
                    var t, n = "0123456789abcdef", o = "", r = 0;
                    r < e.length;
                    r += 1
                )
                    ((t = e.charCodeAt(r)),
            ...
            function i(e, t) {
                return (function (e, t) {
                    ...
                    return (
                        (t = c(r.concat(l(t)), 512 + 8 * t.length)),
                        s(c(i.concat(t), 640))
                    );
                })(n(e), n(t));
            }
    ...
    function j(e) {
        ...
        f.onmessage = function (e) {
            ("file://" !== f.location.origin &&
                e.origin !== f.location.origin) ||
                (e &&
                    e.data &&
