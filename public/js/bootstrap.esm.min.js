...
class Collapse extends BaseComponent {
    ...
    show() {
        ...
        if (t.length) {
            ...
            if (
                ((e = n ? Collapse.getInstance(n) : null),
...
class Dropdown extends BaseComponent {
    ...
    show() {
        ...
        if (
            EventHandler.trigger(this._element, EVENT_SHOW$4, e)
                .defaultPrevented
        )
            return;
    ...
    _activate(e) {
        ...
        (i.classList.add("active"),
            i.classList.contains("dropdown-item")
                ...
                : SelectorEngine.parents(i, ".nav, .list-group").forEach(
                      (e) => {
                          (SelectorEngine.prev(
                              e,
                              ".nav-link, .list-group-item",
                          ).forEach((e) => e.classList.add("active")),
                              SelectorEngine.prev(e, ".nav-item").forEach(
                                  (e) => {
