...
!(function () {
    ...
    function e(t, a) {
        if (t) {
            ...
            return "Map" ===
                (e =
                    "Object" === e && t.constructor ? t.constructor.name : e) ||
                "Set" === e
                ? Array.from(t)
                : "Arguments" === e ||
    ...
    function ut(t, a, e) {
        if (t && t[a] && t[a][e])
            return { prefix: a, iconName: e, icon: t[a][e] };
    }
    p &&
        ((ct = (
            h.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/
        ).test(h.readyState)) ||
            ...
            a = mt(
                ...
                function (t, a) {
                    ...
                    return (
                        "far" !== n || i || (n = "fas"),
                        "string" == typeof e &&
                            (t.names[e] = { prefix: n, iconName: a }),
                        "number" == typeof e &&
                            (t.unicodes[e.toString(16)] = {
                                prefix: n,
                                iconName: a,
                            }),
                        t
    ...
    function Lt(t, a) {
        ...
        return (
            ("fa" !== t.prefix && "fa" !== i) || (t.prefix = kt || "fas"),
            t
        );
    }
    var c = (function () {
    ...
    function Wt(t) {
        ...
        if (a)
            return (
                (a = Et(t, a) || a),
                ut(Ut.definitions, t, a) || ut(ot.styles, t, a)
            );
    }
    var Ut = new c(),
        _t = {
            ...
            parse: {
                icon: function (t) {
                    ...
                    if (
                        "string" == typeof t &&
                        (-1 < t.indexOf("".concat(X.familyPrefix, "-")) ||
                            t.match(R))
                    ) {
    ...
    function qt(t) {
        ...
        var v,
            ...
            n =
                n.found && e.found
                    ? Ht("generateAbstractMask", t) || {
                          children: [],
                          attributes: {},
                      }
                    : Ht("generateAbstractIcon", t) || {
                          children: [],
                          attributes: {},
                      },
            e = n.children,
                ...
                (t[1].forEach(function (t) {
                    a.parentNode.insertBefore(
                        (function a(e, t) {
                            ...
                            var i = n(e.tag);
                            return (
                                Object.keys(e.attributes || []).forEach(
                                    function (t) {
                ...
                la ||
                    ...
                    Q(t).forEach(function (t) {
                        ...
                        ("childList" === t.type &&
                            ...
                            !ia(t.addedNodes[0]) &&
                            (X.searchPseudoElements && s(t.target),
                            r(t.target)),
                            "attributes" === t.type &&
                                t.target.parentNode &&
    ...
    function ha(t) {
        var a =
            "nest" === X.autoReplaceSvg ? pa(t, { styleParser: !1 }) : pa(t);
        ...
        return new Promise(function (e, t) {
            ...
            u && "none" !== d && "" !== d
                ? ((s = l.getPropertyValue("content")),
                  ...
                  !u ||
                  c ||
                  (f && f.getAttribute(C) === n && f.getAttribute(P) === i)
                      ? e()
                      : (b.setAttribute(p, i),
                        f && b.removeChild(f),
                        ((o = (r = {
                    ...
                    t.generateAbstractMask = function (t) {
                        var a = t.children,
                            ...
                            o =
                                ...
                                (o = "scale("
                                    .concat(
                                        (i.size / 16) * (i.flipX ? -1 : 1),
                                        ", ",
                                    )
                                    .concat(
                                        (i.size / 16) * (i.flipY ? -1 : 1),
                                        ") ",
                                    )),
